...
<div class="sidebar">
    ...
    <a href="<?= site_url('admin/customers') ?>" class="active">
...
<div class="content">
    ...
    <!-- Topbar -->
    <div class="topbar">
        <h4><i class="fas fa-users"></i> Customers Management</h4>
        ...
        <div class="table-card">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th><i class="fas fa-shield"></i> Role</th>
                    ...
                    <tbody>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    <?= esc($user->created_at->toDateString()) ?>
                                </td>
                                <td>
                                    <button
                                        ...
                                        data-role="<?= $user->inGroup('admin') ? 'admin' : 'user' ?>"
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p style="font-size: 0.95rem; color: #64748b;">Customers will appear here once they register</p>
                </div>
            <?php endif; ?>
