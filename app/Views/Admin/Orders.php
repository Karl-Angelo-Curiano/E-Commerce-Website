...
<div class="sidebar">
    ...
    <a href="<?= site_url('admin/orders') ?>" class="active">
...
<div class="content">
    ...
    <!-- Topbar -->
    <div class="topbar">
        <h4><i class="fas fa-shopping-cart"></i> Orders Management</h4>
        ...
        <div class="table-card">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>No orders found</p>
                    <p style="font-size: 0.95rem; color: #64748b;">Orders will appear here once customers place them</p>
                </div>
            <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-edit"></i> Edit Order Status</h5>
    ...
    document.querySelectorAll('.editBtn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('editForm').action = 
                "<?= site_url('admin/orders/update/') ?>" + orderId;
        });
    });
